-- gameplaySP2X  Gameboy Advance emulator for LF1000 --
(ported to LF devices by nirvous.)

Prerequisites:
--------------

64MB RAM (this means that a stock Didj cannot run this emulator)
...
0. You will need to obtain a GBA BIOS (Google is your friend!). This file must be named
...
1. Copy all files in the lf1000_binaries folder into a new folder you create on your Leapster Explorer.
   /path/to/your/stuff/gpsp_lf1000


2. Create a new directory:
   mkdir /lib/modules/2.6.31-leapfrog/kernel/drivers/warm/

3. Move the file warm_2.6.31-leapfrog.ko to that new directory
   mv warm_2.6.31-leapfrog.ko /lib/modules/2.6.31-leapfrog/kernel/drivers/warm/ 

4. Do a depmod:
   depmod

5. Place the gba_bios.bin file you obtained into the emulator folder you create on your Leapster Explorer.
   cp gba_bios.bin path/to/your/stuff/gpsp_lf1000

6. Place your game ROMs into the folder
   cp whatever.gba path/to/your/stuff/gpsp_lf1000
